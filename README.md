...
[![Version](https://img.shields.io/badge/version-0.2.3-blue.svg)](https://github.com/SysAdminDoc/AndroidEmulatorPlus/releases)
...
```
┌──────────────────────────────────────────────────────────────────────────────┐
│ AndroidEmulatorPlus v0.2.3  SDK ✓ … 📱 phone …  💻 emu … 📷 🎥 🖥 ⚙       │
├────────────┬─────────────────────────────────────────────────────────────────┤
│ ① Install  │                                                                 │
│ ② AVDs     │                                                                 │
...
asset selection, HTTP Range download resume, and remote migration/import staging
